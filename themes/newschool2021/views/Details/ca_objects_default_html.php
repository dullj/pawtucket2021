				...
				<hr></hr>
					<div class="row" id="object-headers">
						<div class="col-sm-12">	
							...
							{{{<ifcount code="ca_objects.inscriptionSet.inscriptionText" min="1" max="1"><H6>Inscription</H6></ifcount>}}}
							{{{<ifcount code="ca_objects.inscriptionSet.inscriptionText" min="2"><H6>Inscriptions</H6></ifcount>}}}
