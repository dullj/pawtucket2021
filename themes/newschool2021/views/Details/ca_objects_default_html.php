...
?>
			...
			<div class='col-sm-6 col-md-6 col-lg-5'>
				...
				<H4>{{{<unit relativeTo="ca_collections" delimiter="; "><l>^ca_collections.hierarchy.preferred_labels.name%delimiter=➔_</l></unit><ifcount min="1" code="ca_collections"> ➔ </ifcount>}}}{{{ca_objects.preferred_labels.name}}}</H4>
