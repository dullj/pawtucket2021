 ...
 */
	...
	try {
		...
		$resp->addHeader("Content-Security-Policy", "script-src 'self' https://www.googletagmanager.com maps.googleapis.com cdn.knightlab.com ajax.googleapis.com 'unsafe-inline' 'unsafe-eval';"); 
		$resp->addHeader("X-Content-Security-Policy", "script-src 'self' https://www.googletagmanager.com maps.googleapis.com cdn.knightlab.com ajax.googleapis.com 'unsafe-inline' 'unsafe-eval';"); 
