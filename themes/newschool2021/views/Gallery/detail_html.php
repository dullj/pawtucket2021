...
?>
	<div class="row">
		<div class="col-sm-12" id="gallerydetail">
			<H1><?php print $this->getVar("section_name"); ?>: <?php print $this->getVar("label")."</H1>"; ?>
		</div>
	</div>
	<div class="row">
    <div class="col-sm-6" id="galleryDetailObjectInfo"> </div>
		<div class="col-sm-6"><div id="galleryDetailImageArea">
		</div><!-- end galleryDetailImageArea --></div><!--end col-sm-6-->
	</div><!-- end row -->
