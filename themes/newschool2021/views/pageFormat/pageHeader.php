...
?>
			<div class="col-md-12">
      				...
      				<h2 id="site-title"><a href="/pawtucket/index.php">Digital Collections </a> /<span id="collectionguides"><a href="https://findingaids.archives.newschool.edu/" rel="noopener" target="_blank"> Collection Guides</a></span></h2>
    			</div>
...
<?php
							...
							print "<li>".caNavLink($this->request->getController() == "Gallery") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Collection Strengths"), "", "", "Gallery", "Index"); ?>"</li>";
