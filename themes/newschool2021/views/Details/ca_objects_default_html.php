				...
				<hr></hr>
					<div class="row" id="object-headers">
						<div class="col-sm-12">	
							...
							{{{<ifdef code="ca_objects.inscriptionSet.inscriptionText" delimiter="<br/>"><H6>Inscription</H6>^ca_objects.inscriptionSet.inscriptionText%delimiter=;_ <ifdef code="ca_objects.inscriptionType">(^ca_objects.inscriptionType%delimiter=;_)<br/></ifdef></ifdef>}}}
